...
public class Equipo {
    ...
    public void agragarJugador(Jugador jugador) throws EquipoException {
        if(jugadorList.size() > 23){
            throw new EquipoException("El equipo esta completo, no puede agregar mas jugadores.");
        }
    ...
    public int cantJugadores(String posicion) throws EquipoException{
